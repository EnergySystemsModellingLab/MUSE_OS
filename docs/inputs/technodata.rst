...
Growth constraints (optional)
   ...
   * *MaxCapacityAddition* restricts new capacity which can be installed over the investment period to :math:`10 * 5 = 50` PJ.
   * *MaxCapacityGrowth* restricts capacity growth to 20 \% per year (:math:`\approx` 149 \% over 5 years).
     ...
     resBoilerElectric is already commissioned for the investment year, then the constraint applies as follows: :math:`7.7 x (1 + 0.2)^5 - 4.9 = 14.3` PJ.
     Also see the GrowthSeed parameter below.
   * *TotalCapacityLimit* will restrict new addition to :math:`100 - 4.9 = 95.1` PJ (so that total capacity in the investment year will not exceed 100 PJ).
